...
#endif
            phyto(LARGE_)%f_n(i,j,k)   = max( t(i,j,k,nstp,inlg),   0.0d0 )
...
! RD TODO clean 1-4 SMALL-LARGE_
#ifdef COBALT_IRON
      phyto(DIAZO)%q_fe_2_n(:,:,:)= max(0.0d0,phyto(DIAZO)%f_fe(:,:,:) /       &
                                    max(epsln,phyto(DIAZO)%f_n(:,:,:)))
      phyto(LARGE_)%q_fe_2_n(:,:,:)=max(0.0d0,phyto(LARGE_)%f_fe(:,:,:) /      &
                                    max(epsln,phyto(LARGE_)%f_n(:,:,:)))
# ifdef COASTDIAT
      phyto(MEDIUM)%q_fe_2_n(:,:,:)=max(0.0d0,phyto(MEDIUM)%f_fe(:,:,:) /      &
                                    max(epsln,phyto(MEDIUM)%f_n(:,:,:)))
# endif
      phyto(SMALL)%q_fe_2_n(:,:,:)= max(0.0d0,phyto(SMALL)%f_fe(:,:,:) /       &
                                    max(epsln,phyto(SMALL)%f_n(:,:,:)))
#endif

      phyto(DIAZO)%q_p_2_n(:,:,:)  = phyto(DIAZO)%p_2_n_static
      phyto(LARGE_)%q_p_2_n(:,:,:) = phyto(LARGE_)%p_2_n_static
#ifdef COASTDIAT
      phyto(MEDIUM)%q_p_2_n(:,:,:) = phyto(MEDIUM)%p_2_n_static
#endif
...
#ifdef COASTDIAT
        phyto(MEDIUM)%silim(:,:,k) = cobalt%f_sio4(:,:,k) /                    &
     &    (phyto(MEDIUM)%k_sio4 + cobalt%f_sio4(:,:,k)) * rmask_local(:,:)
#endif
      ENDDO
...
#ifdef COBALT_IRON
      phyto(DIAZO )%felim(:,:,:) = cobalt%f_fed(:,:,:) / &
    &   (phyto(DIAZO )%k_fed + cobalt%f_fed(:,:,:))
      phyto(LARGE_)%felim(:,:,:) = cobalt%f_fed(:,:,:) / &
    &   (phyto(LARGE_)%k_fed + cobalt%f_fed(:,:,:))
      phyto(SMALL )%felim(:,:,:) = cobalt%f_fed(:,:,:) / &
    &   (phyto(SMALL )%k_fed + cobalt%f_fed(:,:,:))
# ifdef COASTDIAT
      phyto(MEDIUM)%felim(:,:,:) = cobalt%f_fed(:,:,:) / &
    &   (phyto(MEDIUM)%k_fed + cobalt%f_fed(:,:,:))
# endif

      phyto(DIAZO)%def_fe(:,:,:)=phyto(DIAZO)%q_fe_2_n(:,:,:)**2 / &
    &   (phyto(DIAZO)%k_fe_2_n**2+phyto(DIAZO)%q_fe_2_n(:,:,:)**2)
      phyto(LARGE_)%def_fe(:,:,:)=phyto(LARGE_)%q_fe_2_n(:,:,:)**2 / &
    &   (phyto(LARGE_)%k_fe_2_n**2+phyto(LARGE_)%q_fe_2_n(:,:,:)**2)
      phyto(SMALL)%def_fe(:,:,:)=phyto(SMALL)%q_fe_2_n(:,:,:)**2 / &
    &   (phyto(SMALL)%k_fe_2_n**2+phyto(SMALL)%q_fe_2_n(:,:,:)**2)
# ifdef COASTDIAT
      phyto(MEDIUM)%def_fe(:,:,:)=phyto(MEDIUM)%q_fe_2_n(:,:,:)**2 / &
    &   (phyto(MEDIUM)%k_fe_2_n**2+phyto(MEDIUM)%q_fe_2_n(:,:,:)**2)
# endif
#else
      phyto(DIAZO )%def_fe(:,:,:)=1.
      phyto(LARGE_)%def_fe(:,:,:)=1.
      phyto(SMALL )%def_fe(:,:,:)=1.
      phyto(DIAZO )%felim(:,:,:)=1.
      phyto(LARGE_)%felim(:,:,:)=1.
      phyto(SMALL )%felim(:,:,:)=1.
# ifdef COASTDIAT
      phyto(MEDIUM)%def_fe(:,:,:)=1.
      phyto(MEDIUM)%felim(:,:,:)=1.
# endif
#endif

      DO k=1,UBk
        phyto(DIAZO )%def_fe(:,:,k) = phyto(DIAZO )%def_fe(:,:,k) * rmask_local(:,:)
        phyto(LARGE_)%def_fe(:,:,k) = phyto(LARGE_)%def_fe(:,:,k) * rmask_local(:,:)
        phyto(SMALL )%def_fe(:,:,k) = phyto(SMALL )%def_fe(:,:,k) * rmask_local(:,:)
...
!     nphyto=overflow
      ...
      phyto(LARGE_)%liebig_lim(:,:,:) = min(phyto(LARGE_)%no3lim(:,:,:)+ &
     &                                      phyto(LARGE_)%nh4lim(:,:,:), &
     &                                      phyto(LARGE_)%po4lim,        &
     &                                      phyto(LARGE_)%def_fe )

      phyto(SMALL )%liebig_lim(:,:,:) = min(phyto(SMALL )%no3lim(:,:,:)+ &
     &                                      phyto(SMALL )%nh4lim(:,:,:), &
     &                                      phyto(SMALL )%po4lim,        &
     &                                      phyto(SMALL )%def_fe )

#ifdef COASTDIAT
      phyto(MEDIUM)%liebig_lim(:,:,:) = min(phyto(MEDIUM)%no3lim(:,:,:)+ &
     &                                      phyto(MEDIUM)%nh4lim(:,:,:), &
     &                                      phyto(MEDIUM)%po4lim,        &
     &                                      phyto(MEDIUM)%def_fe )
#endif
...
# ifdef COBALT_IRON
            ! iron diagnostics
            DiaBio3d(i,j,k,idef_fe_sm) = DiaBio3d(i,j,k,idef_fe_sm) + phyto(SMALL)%def_fe(i,j,k)
#  ifdef COASTDIAT
            DiaBio3d(i,j,k,idef_fe_md) = DiaBio3d(i,j,k,idef_fe_md) + phyto(MEDIUM)%def_fe(i,j,k)
#  endif
            DiaBio3d(i,j,k,idef_fe_di) = DiaBio3d(i,j,k,idef_fe_di) + phyto(DIAZO)%def_fe(i,j,k)
            DiaBio3d(i,j,k,idef_fe_lg) = DiaBio3d(i,j,k,idef_fe_lg) + phyto(LARGE_)%def_fe(i,j,k)
            DiaBio3d(i,j,k,ifelim_sm)  = DiaBio3d(i,j,k,ifelim_sm)  + phyto(SMALL)%felim(i,j,k)
#  ifdef COASTDIAT
            DiaBio3d(i,j,k,ifelim_md)  = DiaBio3d(i,j,k,ifelim_md)  + phyto(MEDIUM)%felim(i,j,k)
#  endif
            DiaBio3d(i,j,k,ifelim_di)  = DiaBio3d(i,j,k,ifelim_di)  + phyto(DIAZO)%felim(i,j,k)
            DiaBio3d(i,j,k,ifelim_lg)  = DiaBio3d(i,j,k,ifelim_lg)  + phyto(LARGE_)%felim(i,j,k)
# endif
            ! nitrogen diagnostics
            DiaBio3d(i,j,k,ino3lim_sm) = DiaBio3d(i,j,k,ino3lim_sm) + phyto(SMALL)%no3lim(i,j,k)
# ifdef COASTDIAT
            DiaBio3d(i,j,k,ino3lim_md) = DiaBio3d(i,j,k,ino3lim_md) + phyto(MEDIUM)%no3lim(i,j,k)
# endif
            DiaBio3d(i,j,k,ino3lim_di) = DiaBio3d(i,j,k,ino3lim_di)   !&
   !  &                                  + phyto(DIAZO)%no3lim(i,j,k)
            DiaBio3d(i,j,k,ino3lim_lg) = DiaBio3d(i,j,k,ino3lim_lg) + phyto(LARGE_)%no3lim(i,j,k)
            DiaBio3d(i,j,k,inh4lim_sm) = DiaBio3d(i,j,k,inh4lim_sm) + phyto(SMALL)%nh4lim(i,j,k)
# ifdef COASTDIAT
            DiaBio3d(i,j,k,inh4lim_md) = DiaBio3d(i,j,k,inh4lim_md) + phyto(MEDIUM)%nh4lim(i,j,k)
# endif
            DiaBio3d(i,j,k,inh4lim_di) = DiaBio3d(i,j,k,inh4lim_di)   !&
   !  &                                  + phyto(DIAZO)%nh4lim(i,j,k)
            DiaBio3d(i,j,k,inh4lim_lg) = DiaBio3d(i,j,k,inh4lim_lg) + phyto(LARGE_)%nh4lim(i,j,k)
# ifdef COBALT_PHOSPHORUS
            ! phosphorus diagnostics
            DiaBio3d(i,j,k,ipo4lim_sm) = DiaBio3d(i,j,k,ipo4lim_sm) + phyto(SMALL)%po4lim(i,j,k)
#  ifdef COASTDIAT
            DiaBio3d(i,j,k,ipo4lim_md) = DiaBio3d(i,j,k,ipo4lim_md) + phyto(MEDIUM)%po4lim(i,j,k)
#  endif
            DiaBio3d(i,j,k,ipo4lim_di) = DiaBio3d(i,j,k,ipo4lim_di) + phyto(DIAZO)%po4lim(i,j,k)
            DiaBio3d(i,j,k,ipo4lim_lg) = DiaBio3d(i,j,k,ipo4lim_lg) + phyto(LARGE_)%po4lim(i,j,k)
# endif
          ENDDO
        ENDDO
      ENDDO
...
!     call system_clock(clock1start)
      ...
      DO k=0,UBk
        DO j=Jstr,Jend
          DO i=Istr,Iend
            ! use only visible bands
            swdk3(i,j,k) = (decayW(i,j,k,3) + decayW(i,j,k,4)) * rmask_local(i,j)
          END DO
        END DO
      ENDDO
      i=overflow ; j=overflow ; k=overflow
...
!         DO k=kblt+1,N(ng)
         DO k=kblt,UBk
            cobalt%irr_mix(i,j,k) = tmp_irrad_ML * rmask_local(i,j) / mxl_depth(i,j)
         ENDDO
      ...
      DO k=1,UBk
        DO j=Jstr,Jend
          DO i=Istr,Iend
           ...
           & min(1.0d0,cobalt%gamma_irr_mem * n_dt)) * rmask_local(i,j)
          ENDDO
        ENDDO
      ENDDO
      i=overflow ; j=overflow ; k=overflow
...
!           cobalt%gross_prim_prod(i,j,k) = 0.0
     ...
     &          12.0e6 * phyto(nphyto)%theta(i,j,k) *                &
     &          phyto(nphyto)%f_n(i,j,k) * rmask_local(i,j)
      ...
      DO j=Jstr,Jend
        DO i=Istr,Iend
          DO nphyto=1,NUM_PHYTO
            ...
            DO k=kblt,UBk
              phyto(nphyto)%mu_mix(i,j,k) = tmp_mu_ML * rmask_local(i,j) / mxl_depth(i,j)
            ENDDO
...
! CAS: revised (modified RD code for irr_mem, f_mu_mem new 3D diag for phyto type
     ...
     &          min(1.0d0,cobalt%gamma_mu_mem * n_dt)) * rmask_local(i,j)
            ENDDO
          ENDDO
        ENDDO
      ENDDO
...
!     call system_clock(clock1start)
      ...
      DO k=1,UBk
        nphyto=DIAZO
        phyto(nphyto)%juptake_n2(:,:,k) = max( 0.0,                            &
     &   (1.0 - phyto(LARGE_)%no3lim(:,:,k) - phyto(LARGE_)%nh4lim(:,:,k)) *     &
     &   phyto(nphyto)%mu(:,:,k) * phyto(nphyto)%f_n(:,:,k) ) * rmask_local(:,:)

        phyto(nphyto)%juptake_nh4(:,:,k)=max(0.0,phyto(LARGE_)%nh4lim(:,:,k) * &
     &   phyto(nphyto)%mu(:,:,k)*phyto(nphyto)%f_n(:,:,k)) * rmask_local(:,:)

        phyto(nphyto)%juptake_no3(:,:,k)=max(0.0,phyto(LARGE_)%no3lim(:,:,k) * &
     &   phyto(nphyto)%mu(:,:,k)*phyto(nphyto)%f_n(:,:,k)) * rmask_local(:,:)

       ! If growth is negative, net remineralization of organic material
        phyto(nphyto)%juptake_nh4(:,:,k) = phyto(nphyto)%juptake_nh4(:,:,k) + &
     &   min(0.0,phyto(nphyto)%mu(:,:,k)  * phyto(nphyto)%f_n(:,:,k)) * rmask_local(:,:)

        phyto(nphyto)%jprod_n(:,:,k) = phyto(nphyto)%juptake_nh4(:,:,k)     + &
     &   phyto(nphyto)%juptake_no3(:,:,k) + phyto(nphyto)%juptake_n2(:,:,k)

        DO nphyto=2,NUM_PHYTO

          phyto(nphyto)%juptake_no3(:,:,k)=max(0.0,phyto(nphyto)%mu(:,:,k) * &
     &      phyto(nphyto)%f_n(:,:,k) * phyto(nphyto)%no3lim(:,:,k)           / &
     &     (phyto(nphyto)%no3lim(:,:,k) + phyto(nphyto)%nh4lim(:,:,k)+epsln) ) * rmask_local(:,:)

          phyto(nphyto)%juptake_nh4(:,:,k)=max(0.0,phyto(nphyto)%mu(:,:,k) * &
     &      phyto(nphyto)%f_n(:,:,k) * phyto(nphyto)%nh4lim(:,:,k)           / &
     &     (phyto(nphyto)%no3lim(:,:,k) + phyto(nphyto)%nh4lim(:,:,k)+epsln) ) * rmask_local(:,:)
...
!
      ...
      DO k=1,UBk
        nphyto=DIAZO
        phyto(nphyto)%juptake_po4(:,:,k) = (phyto(nphyto)%juptake_n2(:,:,k)  + &
     &    phyto(nphyto)%juptake_nh4(:,:,k)+phyto(nphyto)%juptake_no3(:,:,k)) * &
     &    phyto(nphyto)%p_2_n_static * rmask_local(:,:)

        DO nphyto=2,NUM_PHYTO
           phyto(nphyto)%juptake_po4(:,:,k)=(phyto(nphyto)%juptake_no3(:,:,k)+ &
           phyto(nphyto)%juptake_nh4(:,:,k)) * phyto(nphyto)%p_2_n_static * rmask_local(:,:)
        ENDDO
      ENDDO
      nphyto=overflow
#endif
...
!
     ...
     &            phyto(nphyto)%felim(i,j,k) * cobalt%fe_2_n_upt_fac * rmask_local(i,j)
              ELSE
...
!
      ...
      cobalt%nlg_diatoms(:,:,:) = phyto(LARGE_)%f_n(:,:,:) *                 &
     &  phyto(LARGE_)%silim(:,:,:)
#ifdef COASTDIAT
     ...
     &  phyto(MEDIUM)%silim(:,:,:)
      ...
      DO k=1,UBk
        cobalt%q_si_2_n_lg_diatoms(:,:,k) = cobalt%f_silg(:,:,k) /            &
     &   (cobalt%nlg_diatoms(:,:,k) + epsln) * rmask_local(:,:)
#ifdef COASTDIAT
        cobalt%q_si_2_n_md_diatoms(:,:,k) = cobalt%f_simd(:,:,k) /            &
     &   (cobalt%nmd_diatoms(:,:,k) + epsln) * rmask_local(:,:)
#endif
      ENDDO

      phyto(LARGE_)%juptake_sio4(:,:,:)=max(phyto(LARGE_)%juptake_no3(:,:,:)+ &
     &  phyto(LARGE_)%juptake_nh4(:,:,:),0.0) * phyto(LARGE_)%silim(:,:,:)    * &
     &  phyto(LARGE_)%silim(:,:,:) * phyto(LARGE_)%si_2_n_max
#ifdef COASTDIAT
...
! RD : forgot this line (oups...)
      DO k=1,UBk
        phyto(LARGE_)%q_si_2_n(:,:,k) = cobalt%f_silg(:,:,k) * rmask_local(:,:) &
              /(phyto(LARGE_)%f_n(:,:,k)+epsln)
#ifdef COASTDIAT
        phyto(MEDIUM)%q_si_2_n(:,:,k) = cobalt%f_simd(:,:,k) * rmask_local(:,:) &
              /(phyto(MEDIUM)%f_n(:,:,k)+epsln)
#endif
      ENDDO
      ...
      DO k=1,Ubk
        DO j=Jstr,Jend
          DO i=Istr,Iend
           ...
           & bact_ldon_lim * bact(1)%f_n(i,j,k) * rmask_local(i,j)
             ...
             IF (bact_uptake_ratio.lt.bact(1)%q_p_2_n) THEN
              ...
              & bact(1)%bresp * bact(1)%f_n(i,j,k)) * rmask_local(i,j)
...
# ifdef COBALT_PHOSPHORUS
      ...
      prey_p2n_vec(2) = phyto(LARGE_)%p_2_n_static
      ...
      DO k=1,UBk
        DO j=Jstr,Jend
          DO i=Istr,Iend
            ...
            !  DIAZO, LARGE_, SMALL ordering inherited from TOPAZ)
            !
            prey_vec(1) = max(phyto(DIAZO)%f_n(i,j,k) - refuge_conc,0.0d0)
            prey_vec(2) = max(phyto(LARGE_)%f_n(i,j,k) - refuge_conc,0.0d0)
...
# ifdef COBALT_IRON
            ...
            prey_fe2n_vec(2) = phyto(LARGE_)%q_fe_2_n(i,j,k)
...
# endif
            prey_si2n_vec(2) = phyto(LARGE_)%q_si_2_n(i,j,k)
            ...
            ztemp_lim_zoo1 = exp(zoo(m)%ktemp*ztemp) * rmask_local(i,j)
     ...
     &                     (zoo(m)%ki+tot_prey(m))
            ...
            zoo(m)%jingest_n(i,j,k) = (ingest_matrix(m,4) + ingest_matrix(m,5)) * rmask_local(i,j)
# ifdef COBALT_PHOSPHORUS
            zoo(m)%jingest_p(i,j,k) = (ingest_matrix(m,4)*prey_p2n_vec(4) +    &
     &                                 ingest_matrix(m,5)*prey_p2n_vec(5)) * rmask_local(i,j)
# endif
# ifdef COBALT_IRON
            zoo(m)%jingest_fe(i,j,k)= ingest_matrix(m,4)*prey_fe2n_vec(4) * rmask_local(i,j)
# endif
            ...
            m = 2
            !zoo(m)%temp_lim(i,j,k) = exp(zoo(m)%ktemp*cobalt%f_temp(i,j,k))
            ztemp_lim_zoo2 = exp(zoo(m)%ktemp*ztemp) * rmask_local(i,j)
...
# ifdef      COBALT_IRON
     ...
     &                                  ingest_matrix(m,3)*prey_fe2n_vec(3)) * rmask_local(i,j)
# endif
            zoo(m)%jingest_sio2(i,j,k) = ingest_matrix(m,3)*prey_si2n_vec(3) * rmask_local(i,j)
     ...
     &                                 ingest_matrix(m,7)) * rmask_local(i,j)
# ifdef COBALT_PHOSPHORUS
            zoo(m)%jingest_p(i,j,k) = (ingest_matrix(m,1)*prey_p2n_vec(1) +    &
     &                            ingest_matrix(m,2)*prey_p2n_vec(2) +    &
     &                            ingest_matrix(m,7)*prey_p2n_vec(7)) * rmask_local(i,j)
# endif
# ifdef COBALT_IRON
            zoo(m)%jingest_fe(i,j,k) = (ingest_matrix(m,1)*prey_fe2n_vec(1) +  &
...
# endif
     ...
     &                                      ingest_matrix(3,DIAZO) ) * rmask_local(i,j)
            ...
            phyto(LARGE_)%jzloss_n(i,j,k) = (ingest_matrix(1,LARGE_)       +     &
     &                                      ingest_matrix(2,LARGE_)       +     &
     &                                      ingest_matrix(3,LARGE_) ) * rmask_local(i,j)
...
# ifdef COBALT_PHOSPHORUS
            ...
            phyto(LARGE_)%jzloss_p(i,j,k) = phyto(LARGE_)%jzloss_n(i,j,k)*prey_p2n_vec(2)
            phyto(MEDIUM)%jzloss_p(i,j,k) = phyto(MEDIUM)%jzloss_n(i,j,k)*prey_p2n_vec(3)
            phyto(SMALL)%jzloss_p(i,j,k) = phyto(SMALL)%jzloss_n(i,j,k)*prey_p2n_vec(4)
# endif

# ifdef COBALT_IRON
            phyto(DIAZO)%jzloss_fe(i,j,k) = phyto(DIAZO)%jzloss_n(i,j,k)*prey_fe2n_vec(1)
            phyto(LARGE_)%jzloss_fe(i,j,k) = phyto(LARGE_)%jzloss_n(i,j,k)*prey_fe2n_vec(2)
            phyto(MEDIUM)%jzloss_fe(i,j,k) = phyto(MEDIUM)%jzloss_n(i,j,k)*prey_fe2n_vec(3)
            phyto(SMALL)%jzloss_fe(i,j,k) = phyto(SMALL)%jzloss_n(i,j,k)*prey_fe2n_vec(4)
# endif

            phyto(DIAZO)%jzloss_sio2(i,j,k) = phyto(DIAZO)%jzloss_n(i,j,k)*prey_si2n_vec(1)
            phyto(LARGE_)%jzloss_sio2(i,j,k) = phyto(LARGE_)%jzloss_n(i,j,k)*prey_si2n_vec(2)
            phyto(MEDIUM)%jzloss_sio2(i,j,k) = phyto(MEDIUM)%jzloss_n(i,j,k)*prey_si2n_vec(3)
            phyto(SMALL)%jzloss_sio2(i,j,k) = phyto(SMALL)%jzloss_n(i,j,k)*prey_si2n_vec(4)
...
# endif
     ...
     &                (zoo(m)%ki+tot_prey(m))
            ...
            zoo(m)%jingest_n(i,j,k) = (ingest_matrix(m,3) + ingest_matrix(m,4)) * rmask_local(i,j)
# ifdef COBALT_PHOSPHORUS
            zoo(m)%jingest_p(i,j,k) = (ingest_matrix(m,3)*prey_p2n_vec(3) +    &
     &                            ingest_matrix(m,4)*prey_p2n_vec(4)) * rmask_local(i,j)
# endif
# ifdef COBALT_IRON
            zoo(m)%jingest_fe(i,j,k)= (ingest_matrix(m,3)*prey_fe2n_vec(3)) * rmask_local(i,j)
# endif
...
# ifdef COBALT_PHOSPHORUS
            phyto(DIAZO)%jzloss_p(i,j,k) = phyto(DIAZO)%jzloss_n(i,j,k)*prey_p2n_vec(1)
            phyto(LARGE_)%jzloss_p(i,j,k) = phyto(LARGE_)%jzloss_n(i,j,k)*prey_p2n_vec(2)
            phyto(SMALL)%jzloss_p(i,j,k) = phyto(SMALL)%jzloss_n(i,j,k)*prey_p2n_vec(3)
# endif

# ifdef COBALT_IRON
            phyto(DIAZO)%jzloss_fe(i,j,k) = phyto(DIAZO)%jzloss_n(i,j,k)*prey_fe2n_vec(1)
            phyto(LARGE_)%jzloss_fe(i,j,k) = phyto(LARGE_)%jzloss_n(i,j,k)*prey_fe2n_vec(2)
            phyto(SMALL)%jzloss_fe(i,j,k) = phyto(SMALL)%jzloss_n(i,j,k)*prey_fe2n_vec(3)
# endif
...
# ifdef DIAGNOSTICS_BIO
            ...
            ! KAK: Predation diagnostics easier to save here (rather than at the
            ! end with all the other source/sink fluxes) b/c ingest_matrix
            ! details are overwritten in this loop
            !
            DiaBio3d(i,j,k,iflx_gra_nsm_nsmz ) = DiaBio3d(i,j,k,iflx_gra_nsm_nsmz ) + ingest_matrix(1,3)
            DiaBio3d(i,j,k,iflx_gra_bac_nsmz ) = DiaBio3d(i,j,k,iflx_gra_bac_nsmz ) + ingest_matrix(1,4)
            DiaBio3d(i,j,k,iflx_gra_ndi_nmdz ) = DiaBio3d(i,j,k,iflx_gra_ndi_nmdz ) + ingest_matrix(2,1)
            DiaBio3d(i,j,k,iflx_gra_nlg_nmdz ) = DiaBio3d(i,j,k,iflx_gra_nlg_nmdz ) + ingest_matrix(2,2)
            DiaBio3d(i,j,k,iflx_gra_nsmz_nmdz) = DiaBio3d(i,j,k,iflx_gra_nsmz_nmdz) + ingest_matrix(2,5)
            DiaBio3d(i,j,k,iflx_gra_ndi_nlgz ) = DiaBio3d(i,j,k,iflx_gra_ndi_nlgz ) + ingest_matrix(3,1)
            DiaBio3d(i,j,k,iflx_gra_nlg_nlgz ) = DiaBio3d(i,j,k,iflx_gra_nlg_nlgz ) + ingest_matrix(3,2)
            DiaBio3d(i,j,k,iflx_gra_nmdz_nlgz) = DiaBio3d(i,j,k,iflx_gra_nmdz_nlgz) + ingest_matrix(3,6)
# endif
...
! end split loop
     ...
     &                         prey_vec(8)*tot_prey_hp/(cobalt%ki_hp+tot_prey_hp)
            ...
            cobalt%hp_jingest_n(i,j,k) = (hp_ingest_vec(7) + hp_ingest_vec(8)) * rmask_local(i,j)
#else
     ...
     &                         prey_vec(7)*tot_prey_hp/(cobalt%ki_hp+tot_prey_hp)
            ...
            cobalt%hp_jingest_n(i,j,k) = (hp_ingest_vec(6) + hp_ingest_vec(7)) * rmask_local(i,j)
#endif
...
! agg_lim is a new 3D diag variable for the phytoplankton type.
      ...
      phyto(DIAZO )%agg_lim(:,:,:) = 0.0
#else
      phyto(DIAZO )%agg_lim(:,:,:) = max(1.0 - phyto(DIAZO)%f_mu_mem(:,:,:)/   &
                                   (0.25*phyto(DIAZO)%P_C_max*cobalt%expkT(:,:,:)),0.0)
#endif
      phyto(LARGE_)%agg_lim(:,:,:) = max(1.0 - phyto(LARGE_)%f_mu_mem(:,:,:)/   &
                                   (0.25*phyto(LARGE_)%P_C_max*cobalt%expkT(:,:,:)),0.0)
      phyto(SMALL )%agg_lim(:,:,:) = max(1.0 - phyto(SMALL)%f_mu_mem(:,:,:)/   &
      ...
      DO k=1,UBk
        ...
        phyto(LARGE_)%agg_lim(:,:,k) = phyto(LARGE_)%agg_lim(:,:,k) * rmask_local(:,:)
        phyto(SMALL )%agg_lim(:,:,k) = phyto(SMALL )%agg_lim(:,:,k) * rmask_local(:,:)
#ifdef COASTDIAT
        phyto(MEDIUM)%agg_lim(:,:,k) = phyto(MEDIUM)%agg_lim(:,:,k) * rmask_local(:,:)
#endif
      ENDDO

      phyto(DIAZO )%jaggloss_n(:,:,:) = (phyto(DIAZO )%agg_lim(:,:,:)**2)*   &
                                   phyto(DIAZO)%agg*phyto(DIAZO)%f_n(:,:,:)**2
      phyto(LARGE_)%jaggloss_n(:,:,:) = (phyto(LARGE_)%agg_lim(:,:,:)**2)*   &
                                   phyto(LARGE_)%agg*phyto(LARGE_)%f_n(:,:,:)**2
      phyto(SMALL )%jaggloss_n(:,:,:) = (phyto(SMALL )%agg_lim(:,:,:)**2)*   &
                                   phyto(SMALL)%agg*phyto(SMALL)%f_n(:,:,:)**2
#ifdef COASTDIAT
      phyto(MEDIUM)%jaggloss_n(:,:,:) = (phyto(MEDIUM)%agg_lim(:,:,:)**2)*   &
                               phyto(MEDIUM)%agg*phyto(MEDIUM)%f_n(:,:,:)**2
#endif


#ifdef COBALT_PHOSPHORUS
      phyto(DIAZO )%jaggloss_p(:,:,:) = phyto(DIAZO )%jaggloss_n(:,:,:)*phyto(DIAZO )%q_p_2_n(:,:,:)
      phyto(LARGE_)%jaggloss_p(:,:,:) = phyto(LARGE_)%jaggloss_n(:,:,:)*phyto(LARGE_)%q_p_2_n(:,:,:)
      phyto(SMALL )%jaggloss_p(:,:,:) = phyto(SMALL )%jaggloss_n(:,:,:)*phyto(SMALL )%q_p_2_n(:,:,:)
# ifdef COASTDIAT
      phyto(MEDIUM)%jaggloss_p(:,:,:) = phyto(MEDIUM)%jaggloss_n(:,:,:)*phyto(MEDIUM)%q_p_2_n(:,:,:)
# endif
#endif

#ifdef COBALT_IRON
      phyto(DIAZO )%jaggloss_fe(:,:,:) = phyto(DIAZO )%jaggloss_n(:,:,:)*phyto(DIAZO )%q_fe_2_n(:,:,:)
      phyto(LARGE_)%jaggloss_fe(:,:,:) = phyto(LARGE_)%jaggloss_n(:,:,:)*phyto(LARGE_)%q_fe_2_n(:,:,:)
      phyto(SMALL )%jaggloss_fe(:,:,:) = phyto(SMALL )%jaggloss_n(:,:,:)*phyto(SMALL )%q_fe_2_n(:,:,:)
# ifdef COASTDIAT
      phyto(MEDIUM)%jaggloss_fe(:,:,:) = phyto(MEDIUM)%jaggloss_n(:,:,:)*phyto(MEDIUM)%q_fe_2_n(:,:,:)
# endif
#endif
...
!     ENDDO
      ...
      DO k=1,UBk
        bact(1)%temp_lim(:,:,k) = bact(1)%temp_lim(:,:,k) * rmask_local(:,:)
      ENDDO

      ! RD rewritten code
      phyto(DIAZO )%jvirloss_n(:,:,:) = bact(1)%temp_lim(:,:,:)*phyto(DIAZO )%vir*phyto(DIAZO )%f_n(:,:,:)**2
      phyto(LARGE_)%jvirloss_n(:,:,:) = bact(1)%temp_lim(:,:,:)*phyto(LARGE_)%vir*phyto(LARGE_)%f_n(:,:,:)**2
      phyto(SMALL )%jvirloss_n(:,:,:) = bact(1)%temp_lim(:,:,:)*phyto(SMALL )%vir*phyto(SMALL )%f_n(:,:,:)**2
#ifdef COASTDIAT
      phyto(MEDIUM)%jvirloss_n(:,:,:) = bact(1)%temp_lim(:,:,:)*phyto(MEDIUM)%vir*phyto(MEDIUM)%f_n(:,:,:)**2
#endif

#ifdef COBALT_PHOSPHORUS
      phyto(DIAZO )%jvirloss_p(:,:,:) = phyto(DIAZO )%jvirloss_n(:,:,:)*phyto(DIAZO )%q_p_2_n(:,:,:)
      phyto(LARGE_)%jvirloss_p(:,:,:) = phyto(LARGE_)%jvirloss_n(:,:,:)*phyto(LARGE_)%q_p_2_n(:,:,:)
      phyto(SMALL )%jvirloss_p(:,:,:) = phyto(SMALL )%jvirloss_n(:,:,:)*phyto(SMALL )%q_p_2_n(:,:,:)
# ifdef COASTDIAT
      phyto(MEDIUM)%jvirloss_p(:,:,:) = phyto(MEDIUM)%jvirloss_n(:,:,:)*phyto(MEDIUM)%q_p_2_n(:,:,:)
# endif
#endif

#ifdef COBALT_IRON
      phyto(DIAZO )%jvirloss_fe(:,:,:) = phyto(DIAZO )%jvirloss_n(:,:,:)*phyto(DIAZO )%q_fe_2_n(:,:,:)
      phyto(LARGE_)%jvirloss_fe(:,:,:) = phyto(LARGE_)%jvirloss_n(:,:,:)*phyto(LARGE_)%q_fe_2_n(:,:,:)
      phyto(SMALL )%jvirloss_fe(:,:,:) = phyto(SMALL )%jvirloss_n(:,:,:)*phyto(SMALL )%q_fe_2_n(:,:,:)
# ifdef COASTDIAT
      phyto(MEDIUM)%jvirloss_fe(:,:,:) = phyto(MEDIUM)%jvirloss_n(:,:,:)*phyto(MEDIUM)%q_fe_2_n(:,:,:)
# endif
#endif

      phyto(DIAZO )%jvirloss_sio2(:,:,:) = phyto(DIAZO )%jvirloss_n(:,:,:)*phyto(DIAZO )%q_si_2_n(:,:,:)
      phyto(LARGE_)%jvirloss_sio2(:,:,:) = phyto(LARGE_)%jvirloss_n(:,:,:)*phyto(LARGE_)%q_si_2_n(:,:,:)
      phyto(SMALL )%jvirloss_sio2(:,:,:) = phyto(SMALL )%jvirloss_n(:,:,:)*phyto(SMALL )%q_si_2_n(:,:,:)
#ifdef COASTDIAT
      phyto(MEDIUM)%jvirloss_sio2(:,:,:) = phyto(MEDIUM)%jvirloss_n(:,:,:)*phyto(MEDIUM)%q_si_2_n(:,:,:)
#endif
      ! RD end rewritten code
...
!
      ...
      phyto(DIAZO )%jexuloss_n(:,:,:) = phyto(DIAZO)%exu*                   &
     &                             max(phyto(DIAZO)%juptake_no3(:,:,:)+     &
     &                             phyto(DIAZO)%juptake_nh4(:,:,:)+phyto(DIAZO)%juptake_n2(:,:,:),0.0)
      phyto(LARGE_)%jexuloss_n(:,:,:) = phyto(LARGE_)%exu*                &
     &  max(phyto(LARGE_)%juptake_no3(:,:,:)+phyto(LARGE_)%juptake_nh4(:,:,:),0.0)
      phyto(SMALL )%jexuloss_n(:,:,:) = phyto(SMALL)%exu*                &
     &  max(phyto(SMALL)%juptake_no3(:,:,:)+phyto(SMALL)%juptake_nh4(:,:,:),0.0)
#ifdef COASTDIAT
      phyto(MEDIUM)%jexuloss_n(:,:,:) = phyto(MEDIUM)%exu*                &
     &  max(phyto(MEDIUM)%juptake_no3(:,:,:)+phyto(MEDIUM)%juptake_nh4(:,:,:),0.0)
#endif

#ifdef COBALT_PHOSPHORUS
      phyto(DIAZO )%jexuloss_p(:,:,:) = phyto(DIAZO )%exu*max(phyto(DIAZO )%juptake_po4(:,:,:),0.0)
      phyto(LARGE_)%jexuloss_p(:,:,:) = phyto(LARGE_)%exu*max(phyto(LARGE_)%juptake_po4(:,:,:),0.0)
      phyto(SMALL )%jexuloss_p(:,:,:) = phyto(SMALL )%exu*max(phyto(SMALL )%juptake_po4(:,:,:),0.0)
# ifdef COASTDIAT
      phyto(MEDIUM)%jexuloss_p(:,:,:) = phyto(MEDIUM)%exu*max(phyto(MEDIUM)%juptake_po4(:,:,:),0.0)
# endif
#endif

#ifdef COBALT_IRON
      phyto(DIAZO )%jexuloss_fe(:,:,:) = phyto(DIAZO )%exu*max(phyto(DIAZO )%juptake_fe(:,:,:),0.0)
      phyto(LARGE_)%jexuloss_fe(:,:,:) = phyto(LARGE_)%exu*max(phyto(LARGE_)%juptake_fe(:,:,:),0.0)
      phyto(SMALL )%jexuloss_fe(:,:,:) = phyto(SMALL )%exu*max(phyto(SMALL )%juptake_fe(:,:,:),0.0)
# ifdef COASTDIAT
      phyto(MEDIUM)%jexuloss_fe(:,:,:) = phyto(MEDIUM)%exu*max(phyto(MEDIUM)%juptake_fe(:,:,:),0.0)
# endif
#endif
...
!
     ...
     &         (PRESS - 1.013) / (382.92 * TK)
            ...
            cobalt%co3_sol_arag(i,j,k) = 10**(-PKSPA) /                       &
     &                  (2.937d-4 * max(5.0, cobalt%f_salt(i,j,k))) *    &
     &                   rmask_local(i,j)
            cobalt%omega_arag(i,j,k) = cobalt%f_co3_ion(i,j,k) /              &
     &         max(cobalt%co3_sol_arag(i,j,k),epsln) * rmask_local(i,j)
     ...
     &         (PRESS - 1.013) / (382.92 * TK)
            ...
            cobalt%co3_sol_calc(i,j,k) = 10**(-PKSPC) /                       &
     &                 (2.937d-4 * max(5.0, cobalt%f_salt(i,j,k))) *     &
     &                 rmask_local(i,j)
            cobalt%omega_calc(i,j,k) = cobalt%f_co3_ion(i,j,k) /              &
     &              max(cobalt%co3_sol_calc(i,j,k),epsln) *              &
     &              rmask_local(i,j)
...
!
     ...
     &                             cobalt%rplith*cobalt%f_lithdet(i,j,k) - &
     &                             cobalt%rpsio2*cobalt%f_sidet(i,j,k) ) * &
     &                             rmask_local(i,j)
            !
...
# ifndef NO_IRON_COAST
            ...
            !
            cobalt%jfe_coast(i,j,k) = fecoast(i,j) * rmask_local(i,j)
...
!
     ...
     &                       (bR(i,ks)+bL(i,ks)-                      &
     &                        2.0_r8*qc(i,ks))))
              FC(i,k-1) = FC(i,k-1) * rmask_local(i,j)
            END DO
          END DO
...
!         cobalt%ffe_sed(i,j) = cobalt%fe_2_n_sed * cobalt%f_ndet_btf(i,j,1) * rmask_local(i,j)
          ! Dale's relationship
          cobalt%ffe_sed(i,j) = cobalt%ffe_sed_max * tanh( (cobalt%f_ndet_btf(i,j,1)*cobalt%c_2_n*sperd*1.0e3)/ &
                        max(cobalt%f_o2(i,j,1)*1.0e6,epsln) ) * 1.e-6/sperd * rmask_local(i,j)
...
! RD : fcased_burial needs to be set at zero for conservation ?
   ...
   !
     ...
     &                        cobalt%f_cadet_arag_btf(i,j,1) -              &
     &                       (cobalt%f_ndet_btf(i,j,1) -                    &
     &                        cobalt%fndet_burial(i,j)) * cobalt%c_2_n ) *  &
     &                        rmask_local(i,j)
...
# endif
          ...
          cobalt%b_o2(i,j)  = cobalt%o2_2_nh4 * (cobalt%fnoxic_sed(i,j) + cobalt%fnfeso4red_sed(i,j)) &
                              * rmask_local(i,j)
#ifdef COBALT_PHOSPHORUS
          cobalt%b_po4(i,j) = (- cobalt%f_pdet_btf(i,j,1) + cobalt%fpdet_burial(i,j) ) * rmask_local(i,j)
#endif
          cobalt%b_sio4(i,j)= - cobalt%f_sidet_btf(i,j,1) * rmask_local(i,j)
...
# endif
     ...
     &                                 zoo(3)%f_n(i,j,k)) * rmask_local(i,j)
  ...
  !!------------------ 100 meters integrals ---------------------
      ...
      DO j=Jstr,Jend
        DO i=Istr,Iend
          ...
          phyto(LARGE_)%jprod_n_100(i,j) = 0.0d0
          phyto(DIAZO)%jprod_n_100(i,j) = 0.0d0
          phyto(SMALL)%jaggloss_n_100(i,j) = 0.0d0
          phyto(LARGE_)%jaggloss_n_100(i,j) = 0.0d0
...
# endif
          ...
          DO k=kdi+1,UBk
            cobalt%f_npp_100(i,j) = cobalt%f_npp_100(i,j) + cobalt%f_npp(i,j,k) * Hz(i,j,k) * rmask_local(i,j)
...
# endif
            ...
            cobalt%jprod_mesozoo_100(i,j) = cobalt%jprod_mesozoo_100(i,j) + &
                                       ...
                                       ( zoo(2)%jprod_n(i,j,k) +  &
                                         zoo(3)%jprod_n(i,j,k) ) * Hz(i,j,k) * rmask_local(i,j)
...
!         cobalt%z_ratio_100(i,j) = cobalt%jprod_mesozoo_100(i,j) /  cobalt%f_npp_100(i,j)
          ...
          cobalt%pe_ratio_100(i,j) = 1035 * 86400 * cobalt%c_2_n * 12 * 1000 *        &
     &                    cobalt%f_ndet(i,j,kdi+1) * wsink(ng) * rmask_local(i,j)

          DiaBio2d(i,j,inpp_100)           = Diabio2d(i,j,inpp_100)           + cobalt%f_npp_100(i,j)
          DiaBio2d(i,j,iprod_n_100_sm)     = DiaBio2d(i,j,iprod_n_100_sm)     + phyto(SMALL)%jprod_n_100(i,j)
          DiaBio2d(i,j,iaggloss_n_100_sm)  = DiaBio2d(i,j,iaggloss_n_100_sm)  + phyto(SMALL)%jaggloss_n_100(i,j)
          DiaBio2d(i,j,izloss_n_100_sm)    = DiaBio2d(i,j,izloss_n_100_sm)    + phyto(SMALL)%jzloss_n_100(i,j)

          DiaBio2d(i,j,iprod_n_100_lg)     = DiaBio2d(i,j,iprod_n_100_lg)     + phyto(LARGE_)%jprod_n_100(i,j)
          DiaBio2d(i,j,iaggloss_n_100_lg)  = DiaBio2d(i,j,iaggloss_n_100_lg)  + phyto(LARGE_)%jaggloss_n_100(i,j)
          DiaBio2d(i,j,izloss_n_100_lg)    = DiaBio2d(i,j,izloss_n_100_lg)    + phyto(LARGE_)%jzloss_n_100(i,j)

          DiaBio2d(i,j,iprod_n_100_di)     = DiaBio2d(i,j,iprod_n_100_di)     + phyto(DIAZO)%jprod_n_100(i,j)
          DiaBio2d(i,j,iaggloss_n_100_di)  = DiaBio2d(i,j,iaggloss_n_100_di)  + phyto(DIAZO)%jaggloss_n_100(i,j)
          DiaBio2d(i,j,izloss_n_100_di)    = DiaBio2d(i,j,izloss_n_100_di)    + phyto(DIAZO)%jzloss_n_100(i,j)

          DiaBio2d(i,j,iprod_n_100_smz)    = DiaBio2d(i,j,iprod_n_100_smz)    + zoo(1)%jprod_n_100(i,j)
          DiaBio2d(i,j,iingest_n_100_smz)  = DiaBio2d(i,j,iingest_n_100_smz)  + zoo(1)%jingest_n_100(i,j)
          DiaBio2d(i,j,izloss_n_100_smz)   = DiaBio2d(i,j,izloss_n_100_smz)   + zoo(1)%jzloss_n_100(i,j)
          DiaBio2d(i,j,ihploss_n_100_smz)  = DiaBio2d(i,j,ihploss_n_100_smz)  + zoo(1)%jhploss_n_100(i,j)
          DiaBio2d(i,j,iprod_ndet_100_smz) = DiaBio2d(i,j,iprod_ndet_100_smz) + zoo(1)%jprod_ndet_100(i,j)

          DiaBio2d(i,j,iprod_n_100_mdz)    = DiaBio2d(i,j,iprod_n_100_mdz)    + zoo(2)%jprod_n_100(i,j)
          DiaBio2d(i,j,iingest_n_100_mdz)  = DiaBio2d(i,j,iingest_n_100_mdz)  + zoo(2)%jingest_n_100(i,j)
          DiaBio2d(i,j,izloss_n_100_mdz)   = DiaBio2d(i,j,izloss_n_100_mdz)   + zoo(2)%jzloss_n_100(i,j)
          DiaBio2d(i,j,ihploss_n_100_mdz)  = DiaBio2d(i,j,ihploss_n_100_mdz)  + zoo(2)%jhploss_n_100(i,j)
          DiaBio2d(i,j,iprod_ndet_100_mdz) = DiaBio2d(i,j,iprod_ndet_100_mdz) + zoo(2)%jprod_ndet_100(i,j)

          DiaBio2d(i,j,iprod_n_100_lgz)    = DiaBio2d(i,j,iprod_n_100_lgz)    + zoo(3)%jprod_n_100(i,j)
          DiaBio2d(i,j,iingest_n_100_lgz)  = DiaBio2d(i,j,iingest_n_100_lgz)  + zoo(3)%jingest_n_100(i,j)
          DiaBio2d(i,j,izloss_n_100_lgz)   = DiaBio2d(i,j,izloss_n_100_lgz)   + zoo(3)%jzloss_n_100(i,j)
          DiaBio2d(i,j,ihploss_n_100_lgz)  = DiaBio2d(i,j,ihploss_n_100_lgz)  + zoo(3)%jhploss_n_100(i,j)
          DiaBio2d(i,j,iprod_ndet_100_lgz) = DiaBio2d(i,j,iprod_ndet_100_lgz) + zoo(3)%jprod_ndet_100(i,j)
...
# endif
          ...
          DiaBio2d(i,j,iprod_mesozoo_100)    = DiaBio2d(i,j,iprod_mesozoo_100)  + cobalt%jprod_mesozoo_100(i,j)
          DiaBio2d(i,j,iz_ratio_100)         = DiaBio2d(i,j,iz_ratio_100)       + cobalt%z_ratio_100(i,j)
          DiaBio2d(i,j,ipe_ratio_100)        = DiaBio2d(i,j,ipe_ratio_100)      + cobalt%pe_ratio_100(i,j)
          DiaBio2d(i,j,if_ratio_100)         = DiaBio2d(i,j,if_ratio_100)       + cobalt%f_ratio_100(i,j)
          DiaBio2d(i,j,iprod_don_100_smz)    = DiaBio2d(i,j,iprod_don_100_smz)  + zoo(1)%jprod_don_100(i,j)
          DiaBio2d(i,j,iprod_don_100_mdz)    = DiaBio2d(i,j,iprod_don_100_mdz)  + zoo(2)%jprod_don_100(i,j)
          DiaBio2d(i,j,iprod_don_100_lgz)    = DiaBio2d(i,j,iprod_don_100_lgz)  + zoo(3)%jprod_don_100(i,j)
...
!          DO k=0,UBk-1
          ...
          DO k=kdi+1,UBk
             cobalt%f_mesozoo_200(i,j) = cobalt%f_mesozoo_200(i,j) + cobalt%f_mesozoo(i,j,k) * &
     &                   Hz(i,j,k) * rmask_local(i,j)
     ...
     &               ( zoo(2)%jprod_n(i,j,k) + zoo(3)%jprod_n(i,j,k) ) * Hz(i,j,k)
          ...
          DiaBio2d(i,j,imesozoo_200)     = DiaBio2d(i,j,imesozoo_200)     + cobalt%f_mesozoo_200(i,j) * &
                    rmask_local(i,j)
          DiaBio2d(i,j,imesozooprod_200) = DiaBio2d(i,j,imesozooprod_200) + cobalt%jprod_mesozoo_200(i,j)
          ! new diag here
      ...
      DO j=Jstr,Jend
         DO i=Istr,Iend
           ...
           ENDDO
           DiaBio2d(i,j,ijno3denit_wc_vint) = DiaBio2d(i,j,ijno3denit_wc_vint) + cobalt%jno3denit_wc_vint(i,j)
         ENDDO
      ENDDO
...
!
      cobalt%jnlg(:,:,:) = phyto(LARGE_)%mu(:,:,:)*phyto(LARGE_)%f_n(:,:,:) -  &
     &                     phyto(LARGE_)%jzloss_n(:,:,:)   -                  &
     &                     phyto(LARGE_)%jhploss_n(:,:,:)  -                  &
     &                     phyto(LARGE_)%jaggloss_n(:,:,:) -                  &
     &                     phyto(LARGE_)%jvirloss_n(:,:,:) -                  &
     &                     phyto(LARGE_)%jexuloss_n(:,:,:)
#ifdef COASTDIAT
!
...
!
      cobalt%jsilg(:,:,:) = phyto(LARGE_)%juptake_sio4(:,:,:)  -              &
     &                      phyto(LARGE_)%jzloss_sio2(:,:,:)   -              &
     &                      phyto(LARGE_)%jhploss_sio2(:,:,:)  -              &
     &                      phyto(LARGE_)%jaggloss_sio2(:,:,:) -              &
     &                      phyto(LARGE_)%jvirloss_sio2(:,:,:)
#ifdef COASTDIAT
!
...
!
      cobalt%jfelg(:,:,:) = phyto(LARGE_)%juptake_fe(:,:,:)  -                &
     &                      phyto(LARGE_)%jzloss_fe(:,:,:)   -                &
     &                      phyto(LARGE_)%jhploss_fe(:,:,:)  -                &
     &                      phyto(LARGE_)%jaggloss_fe(:,:,:) -                &
     &                      phyto(LARGE_)%jvirloss_fe(:,:,:) -                &
     &                      phyto(LARGE_)%jexuloss_fe(:,:,:)
# ifdef COASTDIAT
!
...
!
     ...
     &    phyto(LARGE_)%juptake_no3(:,:,:) + phyto(SMALL)%juptake_no3(:,:,:) + &
#ifdef COASTDIAT
     &    phyto(MEDIUM)%juptake_no3(:,:,:) +                                  &
#endif
     &    cobalt%jprod_nh4(:,:,:) - phyto(DIAZO)%juptake_nh4(:,:,:)         - &
     &    phyto(LARGE_)%juptake_nh4(:,:,:) - phyto(SMALL)%juptake_nh4(:,:,:) - &
#ifdef COASTDIAT
     &    phyto(MEDIUM)%juptake_nh4(:,:,:) -                                  &
#endif
...
# endif
            ...
            !
            ! Source/sink fluxes for N budget (mol N/kg/s)
            !
            ...
            DiaBio3d(i,j,k,iflx_gra_ldon_bac) = DiaBio3d(i,j,k,iflx_gra_ldon_bac) + bact(1)%jprod_n(i,j,k)
            DiaBio3d(i,j,k,iflx_rem_ldon_nh4) = DiaBio3d(i,j,k,iflx_rem_ldon_nh4) + bact(1)%juptake_ldon(i,j,k) - max(bact(1)%jprod_n(i,j,k),0.0)

            ! Zooplankton grazing/predation
            ! (Note: see grazing/predation calcs section above for the rest)

            DiaBio3d(i,j,k,iflx_gra_nsmz_hip) = DiaBio3d(i,j,k,iflx_gra_nsmz_hip) + zoo(1)%jhploss_n(i,j,k)
            DiaBio3d(i,j,k,iflx_gra_nmdz_hip) = DiaBio3d(i,j,k,iflx_gra_nmdz_hip) + zoo(2)%jhploss_n(i,j,k)
            DiaBio3d(i,j,k,iflx_gra_nlgz_hip) = DiaBio3d(i,j,k,iflx_gra_nlgz_hip) + zoo(3)%jhploss_n(i,j,k)

            ! Zooplankton egestion

            DiaBio3d(i,j,k,iflx_ege_nsmz_ndet ) = DiaBio3d(i,j,k,iflx_ege_nsmz_ndet ) + zoo(1)%phi_det  *zoo(1)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nsmz_sldon) = DiaBio3d(i,j,k,iflx_ege_nsmz_sldon) + zoo(1)%phi_sldon*zoo(1)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nsmz_ldon ) = DiaBio3d(i,j,k,iflx_ege_nsmz_ldon ) + zoo(1)%phi_ldon *zoo(1)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nsmz_srdon) = DiaBio3d(i,j,k,iflx_ege_nsmz_srdon) + zoo(1)%phi_srdon*zoo(1)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nmdz_ndet ) = DiaBio3d(i,j,k,iflx_ege_nmdz_ndet ) + zoo(2)%phi_det  *zoo(2)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nmdz_sldon) = DiaBio3d(i,j,k,iflx_ege_nmdz_sldon) + zoo(2)%phi_sldon*zoo(2)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nmdz_ldon ) = DiaBio3d(i,j,k,iflx_ege_nmdz_ldon ) + zoo(2)%phi_ldon *zoo(2)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nmdz_srdon) = DiaBio3d(i,j,k,iflx_ege_nmdz_srdon) + zoo(2)%phi_srdon*zoo(2)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nlgz_ndet ) = DiaBio3d(i,j,k,iflx_ege_nlgz_ndet ) + zoo(3)%phi_det  *zoo(3)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nlgz_sldon) = DiaBio3d(i,j,k,iflx_ege_nlgz_sldon) + zoo(3)%phi_sldon*zoo(3)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nlgz_ldon ) = DiaBio3d(i,j,k,iflx_ege_nlgz_ldon ) + zoo(3)%phi_ldon *zoo(3)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nlgz_srdon) = DiaBio3d(i,j,k,iflx_ege_nlgz_srdon) + zoo(3)%phi_srdon*zoo(3)%jingest_n(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_hip_ndet  ) = DiaBio3d(i,j,k,iflx_ege_hip_ndet  ) + cobalt%hp_phi_det*cobalt%hp_jingest_n(i,j,k)

            ! Aggregation

            DiaBio3d(i,j,k,iflx_agg_ndi_ndet) = DiaBio3d(i,j,k,iflx_agg_ndi_ndet) + phyto(1)%jaggloss_n(i,j,k)
            DiaBio3d(i,j,k,iflx_agg_nlg_ndet) = DiaBio3d(i,j,k,iflx_agg_nlg_ndet) + phyto(2)%jaggloss_n(i,j,k)
            DiaBio3d(i,j,k,iflx_agg_nsm_ndet) = DiaBio3d(i,j,k,iflx_agg_nsm_ndet) + phyto(3)%jaggloss_n(i,j,k)
            ...
            DiaBio3d(i,j,k,iflx_exu_ndi_ldon) = DiaBio3d(i,j,k,iflx_exu_ndi_ldon) + phyto(1)%jexuloss_n(i,j,k)
            DiaBio3d(i,j,k,iflx_exu_nlg_ldon) = DiaBio3d(i,j,k,iflx_exu_nlg_ldon) + phyto(2)%jexuloss_n(i,j,k)
            DiaBio3d(i,j,k,iflx_exu_nsm_ldon) = DiaBio3d(i,j,k,iflx_exu_nsm_ldon) + phyto(3)%jexuloss_n(i,j,k)

            ! Zooplankton egestion (active metabolism)

            DiaBio3d(i,j,k,iflx_ege_nsmz_nh4) = DiaBio3d(i,j,k,iflx_ege_nsmz_nh4) +                    &
                                                zoo(1)%jingest_n(i,j,k)   - zoo(1)%jprod_ndet(i,j,k) - &
     &                                 max(0.0, zoo(1)%jprod_n(i,j,k))    - zoo(1)%jprod_ldon(i,j,k) - &
     &                                          zoo(1)%jprod_sldon(i,j,k) - zoo(1)%jprod_srdon(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nmdz_nh4) = DiaBio3d(i,j,k,iflx_ege_nmdz_nh4) +                    &
                                                zoo(2)%jingest_n(i,j,k)   - zoo(2)%jprod_ndet(i,j,k) - &
     &                                 max(0.0, zoo(2)%jprod_n(i,j,k))    - zoo(2)%jprod_ldon(i,j,k) - &
     &                                          zoo(2)%jprod_sldon(i,j,k) - zoo(2)%jprod_srdon(i,j,k)
            DiaBio3d(i,j,k,iflx_ege_nlgz_nh4) = DiaBio3d(i,j,k,iflx_ege_nlgz_nh4) +                    &
                                                zoo(3)%jingest_n(i,j,k)   - zoo(3)%jprod_ndet(i,j,k) - &
     ...
     &                                          zoo(3)%jprod_sldon(i,j,k) - zoo(3)%jprod_srdon(i,j,k)
            ...
            DiaBio3d(i,j,k,iflx_ege_hip_nh4) = DiaBio3d(i,j,k,iflx_ege_hip_nh4) + (1.0-cobalt%hp_phi_det)*cobalt%hp_jingest_n(i,j,k)
            ...
            if (k.eq.1) then
              cff_btf = 1.0d0 / ( rho0 * Hz(i,j,1) )
              DiaBio3d(i,j,k,iflx_sed_out_nh4) = DiaBio3d(i,j,k,iflx_sed_out_nh4) -(cobalt%b_nh4(i,j) * cff_btf)
              DiaBio3d(i,j,k,iflx_sed_out_no3) = DiaBio3d(i,j,k,iflx_sed_out_no3) -(cobalt%b_no3(i,j) * cff_btf)
            endif
...
!----------------------------------------------------------------------------------------
      ...
      DO k=1,UBk
        DO j=Jstr,Jend
          DO i=Istr,Iend
             zvolume = zvolume + ( omn(i,j) * rmask_local(i,j) * Hz(i,j,k) )
          ENDDO
        ENDDO
      ENDDO
