...
** ALBEDO_DIRDIFF      use if albedo function of direct vs. diffuse          **
...
** DIAGBIOAVG          Report biological diagnostics as time-averages rather **
**                     than history-like snapshots                           **
**                     [FENNEL*, BIO_COBALT*, BEST_NPZ, BANAS]               **
**                     *automatically turned on vs optional                  **
**                                                                           **
...
*******************************************************************************
** Kate's apps
** JAVA_1          South of Java example
** MEDDY           Meddy Test for doubly-periodic
** WBC_1           Western Boundary Current 0 degrees
** WBC_2           Western Boundary Current 17 degrees
** WBC_3           Western Boundary Current 45 degrees
...
** ICE_BASIN       for Ice-covered Ocean Basin Example
** ICE_OCEAN_1D    Test ice-ocean coupling, thermodynamics
** LARGE_AREA_0_8  Atlantic + Arctic region
** BARENTS_0_2     Barents Sea region
** CONMAN          CONMAN 4 km  grid
** MOZAMBIQUE_LA   for Mozambique large-area
** WAP_0_1         Western Antarctic Peninsula region
** WAP_0_1_1       Western Antarctic Peninsula region - larger domain
** WAP_0_1_2       Western Antarctic Peninsula region - larger domain
** ACC_1           ACC
** NPac            GLOBEC North Pacific
** GLOBAL_20KM     Global model with 20 km res.in N.Atlantic, Arctic
** GLOBAL_TEST     Global model with 40 km res.in N.Atlantic, Arctic
** MARECO          Mid_Atlantic Ridge 5 min x 3 min
** BARENTS_1D      Test ice-ocean coupling, thermodynamics
